...
export function Header() {
  ...
  return (
    <>
      <header className="relative w-full z-50 glass-card border-b border-card-border transition-all duration-300 ease-in-out hover:opacity-100 opacity-90 safe-top">
