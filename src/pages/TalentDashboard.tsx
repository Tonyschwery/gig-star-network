  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col gap-4 mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-muted-foreground text-sm sm:text-base">Manage your talent profile and opportunities</p>
            </div>
          </div>
          
          {/* Action Buttons */}
          <div className="flex flex-wrap gap-2">
            {/* Switch to Booking Button */}
            <ModeSwitch size="sm" />
        ...
        {/* Integrated Tabs: Direct Bookings & Gig Opportunities */}
        <TalentDashboardTabs 
          talentId={profile.id}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6 mt-8">
